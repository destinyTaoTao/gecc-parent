...
import com.glsx.vasp.admin.common.config.shiro.ShiroLoginFilter;
import com.glsx.vasp.admin.common.config.shiro.ShiroProperties;
import com.glsx.vasp.admin.common.config.shiro.ShiroRealm;
import lombok.Data;
...
public class ShiroConfig {
    ...
    public HashedCredentialsMatcher credentialsMatcher() {
        ...
        hashedCredentialsMatcher.setHashIterations(shiroProperties.getHashIterations());// 散列的次数，比如散列两次，相当于md5(md5(""));
