...
import com.glsx.vasp.framework.entity.SysLogEntity;
...
//    private MongoTemplate mongoTemplate;
     ...
     * @param joinPoint
     */
    public void saveSysLog(JoinPoint joinPoint, Long operatorId) {
...
//                Integer userId = SessionUtil.getUserId(visitChannel);
                if (operatorId != null) sysLog.setOperator(operatorId);
